...
import { ArrowRight, CheckCircle, Clock, FileText, Bell, Users, Shield } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold text-gray-900">Request Manager</span>
                        </div>
            ...
            <div className="flex min-h-[calc(100vh-73px)]">
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-blue-600 p-12 flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative">
                        <h1 className="text-4xl font-bold text-white mb-6">Streamline Your Workflow</h1>
                        <p className="text-blue-100 text-lg mb-8">A comprehensive request management system for leave, equipment, and overtime approvals</p>
                        
                        <div className="grid grid-cols-2 gap-6">
                            <div className="col-span-2">
                                <h3 className="text-xl font-semibold text-white mb-4">Simple Workflow Process</h3>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <p className="text-blue-100">Create and submit your request</p>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="flex-shrink-0 w-8 h-8 bg-blue-500/30 rounded-full flex items-center justify-center">
                                            <span className="text-white">3</span>
                                        </div>
                                        <p className="text-blue-100">Receive real-time notifications on approval status</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="bg-blue-500/20 rounded-lg p-6 backdrop-blur-sm">
                                ...
                                <p className="text-blue-100">Separate dashboards for requesters and approvers</p>
                            </div>
                            <div className="bg-blue-500/20 rounded-lg p-6 backdrop-blur-sm">
                                <Bell className="h-6 w-6 text-white mb-3" />
                                <h4 className="text-lg font-semibold text-white mb-2">Email Notifications</h4>
                                <p className="text-blue-100">Instant updates on request status changes</p>
                            </div>
                            <div className="bg-blue-500/20 rounded-lg p-6 backdrop-blur-sm">
                                <Shield className="h-6 w-6 text-white mb-3" />
                                <h4 className="text-lg font-semibold text-white mb-2">Secure Authentication</h4>
                                <p className="text-blue-100">Google SSO integration for safe access</p>
                            </div>
                            <div className="bg-blue-500/20 rounded-lg p-6 backdrop-blur-sm">
                                <Clock className="h-6 w-6 text-white mb-3" />
                                <h4 className="text-lg font-semibold text-white mb-2">Real-Time Tracking</h4>
                                <p className="text-blue-100">Monitor request status in real-time</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-md w-full space-y-8">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-sm text-gray-600">
                                Your one-stop solution for managing leave, equipment, and overtime requests
                            </p>
                        </div>
